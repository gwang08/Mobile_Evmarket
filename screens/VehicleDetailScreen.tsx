...
export default function VehicleDetailScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Action Buttons - Only show if vehicle is AVAILABLE and no deposit paid */}
      {vehicle.status === "AVAILABLE" && !depositPaidTransaction && (
        <ActionButtons
          price={vehicle.price}
          productId={vehicleId}
          productType="vehicle"
